...
export default function Chain() {
  ...
  return (
    <section className="bg-[#0B1F3B] py-20 md:py-28">
      <div className="max-w-5xl mx-auto px-6">
        <h2 className="text-[28px] sm:text-[36px] lg:text-[44px] font-semibold tracking-[-0.02em] text-white leading-[1.2] text-center mb-14">
          {t.chain.headline}
        </h2>
        ...
        <p className="mt-14 text-center text-[17px] sm:text-[20px] font-semibold text-white/70">
          {t.chain.closingLine}
        </p>
      </div>
    </section>

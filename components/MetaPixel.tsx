...
export default function MetaPixel() {
  ...
  // GDPR: only load after user accepts cookies. Reads the stored answer rather
  ...
  // No <noscript> tracking pixel. Consent is read from localStorage in an
  // effect, so this component renders nothing at all until JavaScript has run,
  // which means a <noscript> fallback could never do its job anyway.
  return (

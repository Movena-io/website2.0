    ...
    <section className="bg-[#F8FAFC] py-20 border-t border-b border-[#E2E8F0]">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div ref={headerRef} className="reveal text-center max-w-[640px] mx-auto mb-14">
          ...
          <h2 className="text-[28px] sm:text-[34px] lg:text-[44px] font-bold tracking-[-0.02em] text-[#0B1F3B] leading-[1.2]" style={{ textWrap: 'balance' } as React.CSSProperties}>
            Movena is purpose-built for moving companies
          </h2>
          <p className="mt-4 text-[16px] sm:text-[18px] font-normal text-[#475569] leading-[1.7]">

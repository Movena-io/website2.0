  ...
  en: {
    ...
    features: {
      ...
      tabs: [
        ...
        {
          label: 'Quoting',
          badge: 'Three pricing engines',
          title: 'Quotes built from your real pricing, sent in minutes.',
          description: 'Pick how you price: hourly, by square meters, or manual. Set the rules once. Movena calculates every quote against your rates, including transport, floor level, parking, packing, and weekend surcharges. Customers accept the quote online and it lands straight in your pipeline.',
          points: [
            'Hourly, m², or manual pricing engines per workspace',
            'Furniture catalog and rental billing built in',
            'Customers accept online; accepted quotes become jobs automatically',
          ],
        },
        {
          label: 'Quote form',
        ...
        },
        {
          ...
          description: 'Pipeline view from new lead through quote sent to job scheduled to completed. Every person and company gets a full activity history. Convert a lead into a job in one click; the quote, contact, and addresses carry over.',
          points: [
            'Lead pipeline with live stage tracking',
            'People and companies with full contact history',
            'One-click lead-to-job conversion',
          ],
        },
        {
          label: 'Calendar & crew',
          ...
          description: 'Day, week, and month views with crew availability built in. Drag unscheduled jobs onto open slots. Each crew gets their own assignments, certifications, and standard equipment kit. No more morning calls.',
          points: [
            'Day, week, and month views with unscheduled-jobs panel',
            'Crew availability and certifications matched to job requirements',
            'Vehicles tracked alongside jobs with standard equipment kits',
          ],
        },
        {
          label: 'Operations',
          badge: 'Storage, inventory, vehicles',
          title: 'Know what you have, where it is, and what is on loan.',
          description: 'Track storage units billed to customers. Manage your moving materials catalog: boxes, packing, equipment. Maintain vehicle records with standard kits so each truck leaves fully loaded for the job type.',
          points: [
            'Storage units with rental billing',
            'Materials catalog with on-hand and on-loan counts',
            'Vehicles with standard equipment kits per job type',
          ],
        },
        {
          label: 'Automations',
  ...
  da: {
    ...
    features: {
      ...
      tabs: [
        ...
        {
          label: 'Tilbud',
          badge: 'Tre prismodeller',
          title: 'Tilbud bygget på dine reelle priser, sendt på minutter.',
          description: 'Vælg hvordan du priser: timepris, kvadratmeter eller manuelt. Sæt reglerne op én gang. Movena beregner hvert tilbud ud fra dine satser, inklusive transport, etage, parkering, pakning og weekendtillæg. Kunderne accepterer online, og tilbuddet lander direkte i din pipeline.',
          points: [
            'Timepris, m² eller manuel prismodel pr. arbejdsområde',
            'Møbelkatalog og udlejningsfakturering indbygget',
            'Kunder accepterer online; accepterede tilbud bliver til jobs automatisk',
          ],
        },
        {
        ...
        },
        {
          ...
          description: 'Pipeline fra nyt lead via tilbud sendt, job planlagt, til afsluttet. Hver person og virksomhed får fuld aktivitetshistorik. Konvertér et lead til et job med ét klik; tilbud, kontakt og adresser følger med.',
          points: [
            'Lead-pipeline med live status-tracking',
            'Personer og virksomheder med fuld kontakthistorik',
            'Ét-klik konvertering fra lead til job',
          ],
        },
        {
          label: 'Kalender & crew',
          ...
          description: 'Dag-, uge- og månedsoversigt med crewets tilgængelighed indbygget. Træk uplanlagte jobs ind på ledige tider. Hvert crewmedlem har egne opgaver, certifikater og standardudstyrskit. Slut med morgenopkald.',
          points: [
            'Dag-, uge- og månedsvisning med panel for uplanlagte jobs',
            'Crewets tilgængelighed og certifikater matches med jobkrav',
            'Køretøjer tracked sammen med jobs og standardudstyrskit',
          ],
        },
        {
          label: 'Drift',
          badge: 'Lager, materialer, køretøjer',
          title: 'Ved hvad du har, hvor det er, og hvad der er udlånt.',
          description: 'Tracke lagerenheder faktureret til kunder. Administrér dit materialekatalog: kasser, emballage, udstyr. Vedligehold køretøjsdata med standardkits, så hver bil kører fuldt udstyret til jobtypen.',
          points: [
            'Lagerenheder med udlejningsfakturering',
            'Materialekatalog med antal på lager og udlånt',
            'Køretøjer med standardudstyrskit pr. jobtype',
          ],
        },
        {

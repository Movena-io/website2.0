...
export const translations = {
  en: {
      ...
      tabs: [
        {
          ...
          description: "Open Movena at 7am. You see today's jobs, alerts and deadlines, your lead funnel, revenue for the last 12 months, and the recent activity stream. Before the first call of the day.",
          points: [
        ...
        },
        {
          ...
          title: 'Set your prices once. Every quote calculated against your real rates.',
          description: 'Configure your pricing rules in settings: price per m³, minimum price, surcharges for floors, heavy items, packing help, and transport based on Google Maps distance. Movena applies the rules to every quote automatically, so you stop hand-calculating prices.',
          points: [
            'Pricing rules per workspace: m³, hourly, or manual',
            'Surcharges for floors, heavy items, packing, transport per km',
        ...
        },
        {
          ...
          description: 'Build a multi-step quote form with your own branding, colors, and steps. Embed it on your site, or share a direct link. Private and business modes. Submitted forms create a lead, a contact, and a quote in one transaction.',
          points: [
            'Configurable steps: addresses, dates, inventory, price estimate, thank-you',
            'Embed widget with your colors, logo, and header — looks native to your site',
            'Private form for residential leads, business form for B2B',
          ],
        },
        {
          label: 'Leads & jobs',
          ...
          description: 'Pipeline view from new lead through quote sent to job scheduled to completed. Move-specific fields per lead: addresses with floor and elevator, square meters, move date, source. Convert a lead into a job in one click; the quote, contact, and addresses carry over.',
          points: [
            'Lead pipeline with live stage tracking and aging alerts',
            'Move-specific fields: floor, elevator, stairs, m², move date',
            'Pricing history per lead with valid-until dates',
        ...
        },
        {
          ...
          description: 'Day, week, and month views with crew availability built in. Drag unscheduled jobs onto open slots. Each crew member has their own profile with role, hourly rate, competencies, and status. No more morning calls.',
          points: [
        ...
        },
        {
          ...
          description: 'Track storage units billed to customers, with occupancy, monthly revenue, and overdue payments at a glance. Manage your moving materials catalog: boxes, packing, equipment. Every stock movement logged automatically with reorder thresholds.',
          points: [
            'Storage units with occupancy, MRR, and overdue tracking',
            'Inventory catalog with stock, rentals, equipment, and vehicle kits',
        ...
        },
        {
          ...
          description: 'Define automation flows that fire on every meaningful event: new lead, quote sent, quote accepted, job scheduled, job completed, storage renewal, review request, and more. Templates with variables. Runs every 15 minutes in the background.',
          points: [
    ...
    pricing: {
      label: 'Pricing',
      headline: 'Pay per user.',
      highlight: "That's it.",
      subheadline: 'No tiers. No per-quote fees. No minimums. Add admin and crew seats as your business grows.',
      ...
      items: [
        {
          ...
          answer: 'Per-user pricing. 279 DKK per admin per month, 149 DKK per crew member per month. No tiers, no minimums, no per-quote fees. Annual billing saves 17%. The 14-day free trial requires no card and includes the full product.',
        },
        {
  ...
  da: {
      ...
      tabs: [
        {
          ...
          description: 'Åbn Movena kl. 7. Du ser dagens jobs, alarmer og deadlines, din lead-funnel, omsætning for de seneste 12 måneder og den seneste aktivitet. Inden dagens første opkald.',
          points: [
        ...
        },
        {
          ...
          title: 'Sæt dine priser op én gang. Hvert tilbud beregnes ud fra dine reelle satser.',
          description: 'Konfigurér dine prisregler i indstillinger: pris pr. m³, minimumspris, tillæg for etager, tunge genstande, pakkehjælp og transport baseret på Google Maps-afstand. Movena anvender reglerne på hvert tilbud automatisk, så du slipper for at regne priser i hånden.',
          points: [
            'Prisregler pr. arbejdsområde: m³, timepris eller manuel',
            'Tillæg for etager, tunge genstande, pakning, transport pr. km',
        ...
        },
        {
          ...
          description: 'Byg en flertrinsformular med din egen branding, farver og steps. Indbyg den på dit site, eller del et direkte link. Privat- og erhvervstilstand. Indsendte formularer opretter et lead, en kontakt og et tilbud i én transaktion.',
          points: [
            'Konfigurerbare steps: adresser, datoer, inventar, prisoverslag, tak-side',
            'Indbygningswidget med dine farver, logo og header — ser ud som en del af dit site',
            'Privatformular til private leads, erhvervsformular til B2B',
          ],
        },
        {
          label: 'Leads & jobs',
          ...
          description: 'Pipeline fra nyt lead via tilbud sendt, job planlagt, til afsluttet. Flytte-specifikke felter pr. lead: adresser med etage og elevator, kvadratmeter, flyttedato, kilde. Konvertér et lead til et job med ét klik; tilbud, kontakt og adresser følger med.',
          points: [
            'Lead-pipeline med live status-tracking og aldringsalarmer',
            'Flytte-specifikke felter: etage, elevator, trappe, m², flyttedato',
            'Prisoverslagshistorik pr. lead med gyldig-til-datoer',
        ...
        },
        {
          ...
          description: 'Dag-, uge- og månedsoversigt med crewets tilgængelighed indbygget. Træk uplanlagte jobs ind på ledige tider. Hvert crewmedlem har sin egen profil med rolle, timepris, kompetencer og status. Slut med morgenopkald.',
          points: [
        ...
        },
        {
          ...
          description: 'Tracke lagerenheder faktureret til kunder med belægning, månedlig omsætning og forfaldne betalinger på ét blik. Administrér dit materialekatalog: kasser, emballage, udstyr. Hver lagerbevægelse logges automatisk med genbestillingsgrænser.',
          points: [
        ...
        },
        {
          ...
          description: 'Definér automation-flows der udløses ved hver vigtig hændelse: nyt lead, tilbud sendt, tilbud accepteret, job planlagt, job afsluttet, lagerforny, anmeldelsesanmodning og mere. Skabeloner med variabler. Kører hvert 15. minut i baggrunden.',
          points: [
    ...
    pricing: {
      label: 'Priser',
      headline: 'Betal pr. bruger.',
      highlight: 'Det er det.',
      subheadline: 'Ingen pakker. Ingen pris pr. tilbud. Ingen minimumsforbrug. Tilføj admin- og crew-pladser, når din forretning vokser.',
      ...
      items: [
        {
          ...
          answer: 'Pris pr. bruger. 279 DKK pr. admin pr. måned, 149 DKK pr. crewmedlem pr. måned. Ingen pakker, intet minimum, ingen pris pr. tilbud. Årlig fakturering sparer 17%. De 14 dages gratis prøveperiode kræver ingen kortoplysninger og inkluderer hele produktet.',
        },
        {
